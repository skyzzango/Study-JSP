...
<%
	...
	List<ContentDTO> searchList;
	searchList = ContentDAO.getInstance().getSearchList(search);
	if (searchList == null) {
		response.getWriter().println("<script>alert('검색에 실패하였습니다')</script>");
...
<head>
	...
	<title>Content Search Page</title>
</head>
...
<div class="container">
	...
	<div class="starter-template">
		...
		<% assert searchList != null;
			for (ContentDTO content : searchList) { %>
		<div class="row">
			<div class="col-lg-9">
							...
							<div class="col-9">
								...
								<div class="row">
									...
									<div class="col-3 text-right">
										...
										<a onclick="return confirm('신고 하시겠습니까?')" href="./likeAction.jsp?evaluationId=">삭제</a>
									</div>
								</div>
							</div>
						</div>
